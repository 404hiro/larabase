...
import { update as linkUpdate } from '@/actions/App/Http/Controllers/LinkController';
                ...
                >
                    ...
                    <div class="mt-6 grid gap-6">
                        <div class="grid gap-2">
                            ...
                            />
                            <InputError
                                :message="settingsForm.errors.display_name"
                            />
                        </div>
                        ...
                        <div class="grid gap-2">
                            ...
                            <InputError
                                :message="settingsForm.errors.title_id"
                            />
                        </div>
                        ...
                        <div class="grid gap-2">
                            ...
                            <div class="flex items-center justify-between gap-3">
                                <InputError
                                    :message="settingsForm.errors.bio"
                                />
                                <span
                        ...
                        <div class="space-y-3">
                            ...
                            >
                                ...
                                <input
                                    v-model="settingsForm.is_published"
                                    type="checkbox"
                                    class="size-4"
                                />
                            </label>
                            ...
                            >
                                ...
                                <input
                                    v-model="settingsForm.has_web_display"
                                    type="checkbox"
                                    class="size-4"
                                />
                            </label>
